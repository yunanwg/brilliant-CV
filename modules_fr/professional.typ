...
#cvEntry(
    ...
    description: list(
      [Analyser des ensembles de données avec SQL et Python, collaborations interfonctionnelles pour identifier des idées commerciales.],
      [Création de visualisations de données et de tableaux de bord avec Tableau, développer et maintenir des pipelines de données avec AWS],
    )
)
